...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'statement_form_id'     => 'Форма заявления',
        'statement_view_id'     => 'Вид заявления',
        'fio'                   => 'Фамилия Имя Отчество',
        'criminal_code_id'      => 'Статья по которой проходит заявитель',
        'document'              => 'Документ',
        'register_address'      => 'Адрес регистрации заявителя',
        'fact_address'          => 'Адрес фактического проживания',
        'register_place'        => 'Место подачи заявления',
        'inn'                   => 'ИНН',
        'birthday'              => 'Дата рождения',
        'citizenship_id'        => 'Гражданство',
        'social_status_id'      => 'Соц. статус',
        'phone'                 => 'Номер заявителя',
        'applicant_is_id'       => 'Заявитель является',
        'applicant_statuses_id' => 'Статус заявителя',
        'fact_time_arrest'      => 'Время фактического задержания',
        'period_day'            => 'Задержание',
        'desc'                  => 'Примечание',

        'coord_region_id'       => 'Район',
        'lawyer_id'             => 'Дежурные адвокаты этого района',
        'lawyer_next_id'        => 'Дежурные адвокаты следующих дней',

        'decline_desc'          => 'Обоснование отказа',
        'decision_id'           => 'Решения о замене',
    ],
];
