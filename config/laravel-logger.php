...
return [
    ...
    */
    ...
    'rolesMiddlware' => env('LARAVEL_LOGGER_ROLES_MIDDLWARE', 'role:Администратор'),
    ...
    */
    ...
    'loggerBladeExtended'       => env('LARAVEL_LOGGER_LAYOUT', 'bash/layouts/app'),
...
// vendor\jeremykenedy\laravel-logger\src\App\Http\Traits\UserAgentDetails.php
// Заменить на return \Locale::acceptFromHttp($locale);
// 106 строка
